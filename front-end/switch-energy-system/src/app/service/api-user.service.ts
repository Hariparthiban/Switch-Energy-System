...
export class ApiUserService {
  ...
  providerUrl = "http://localhost:8080/providers/"
    ...
    create(data:UserInfo):Observable<Respond>
    {
    ...
    defaultMeter(userId: string | null | undefined):Observable<object>
    {
       return this.http.post<object>(`${this.meterUrl}${userId}/enroll`,null);
    }
    ...
    switchProvider(meterId:string | null | undefined,providerName:string | null |undefined):Observable<void>
     {
         return this.http.put<void>(`${this.providerUrl}Readings/${meterId}`,null);
    }
